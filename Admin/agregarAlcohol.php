...
<body>
<form action="backendAgregarAlcohol.php" method="POST">
Nombre: <input type="text" placeholder="Alcohol" name="nombre"><br>
Fecha De Vencimiento: <input type="date" name="fechaVencimiento"><br>
Cantidad de ML: <input type="text" placeholder="Cantidad de ML" name="cantML"><br>
Precio: <input type="number" placeholder="Precio" name="precio"><br>
